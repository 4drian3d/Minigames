...
public class MenuItemTeam extends MenuItem {
    ...
    private void setTeamIcon() {
        ...
        switch (team.getColor()) {
            case RED, DARK_RED -> m.setColor(Color.RED);
            case BLUE, DARK_BLUE -> m.setColor(Color.BLUE);
            case GREEN, DARK_GREEN -> m.setColor(Color.GREEN);
            ...
            case PURPLE, DARK_PURPLE -> m.setColor(Color.PURPLE);
        }
